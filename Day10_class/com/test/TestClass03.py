#__Class__
# 인스턴스가 자신을 생성한 클래스 객체를 참조하기 위하여 파이선에서 제공하는 키워드로 클래스영역(heap)에
...
if __name__ == '__main__':
    ...
    print(Emp.empno, Emp.result) #staptic
